...
static kal_uint32 GC0312_g_fPV_PCLK = 15000000;
...
void GC0312NightMode(kal_bool bEnable)
{
	...
	if (bEnable) {
		...
		if (GC0312_MPEG4_encode_mode == KAL_TRUE) {
			...
			GC0312_write_cmos_sensor(0x08, 0x8f);		/*10*/
			GC0312_write_cmos_sensor(0xfe, 0x01);
			GC0312_write_cmos_sensor(0x25, 0x00);
			GC0312_write_cmos_sensor(0x26, 0x81);		/*9a   1step   30*/
			GC0312_write_cmos_sensor(0x27, 0x01);
			GC0312_write_cmos_sensor(0x28, 0x02);		/*2step  level 1  30*/
			GC0312_write_cmos_sensor(0x29, 0x02);
			GC0312_write_cmos_sensor(0x2a, 0x04);		/*4step level 2  25*/
			GC0312_write_cmos_sensor(0x2b, 0x04);
			GC0312_write_cmos_sensor(0x2c, 0x08);		/*8step level 3  14*/
			GC0312_write_cmos_sensor(0x2d, 0x05);
			GC0312_write_cmos_sensor(0x2e, 0x0a);		/*10step level 4  12.5*/
			GC0312_write_cmos_sensor(0x2f, 0x06);
			GC0312_write_cmos_sensor(0x30, 0x0c);		/*15step  level 5  10*/
			GC0312_write_cmos_sensor(0x31, 0x06);
			GC0312_write_cmos_sensor(0x32, 0x0c);		/*16 step  level 6  10*/
			GC0312_write_cmos_sensor(0x33, 0x06);
			GC0312_write_cmos_sensor(0x34, 0x0c);		/*17step level 7  10*/
			GC0312_write_cmos_sensor(0x35, 0x10);		/*2x level 1*/
			GC0312_write_cmos_sensor(0x36, 0x10);		/*2x   level 2*/
			GC0312_write_cmos_sensor(0x37, 0x18);		/*3x   level 3*/
			GC0312_write_cmos_sensor(0x38, 0x18);		/*3x  level 4*/
			GC0312_write_cmos_sensor(0x39, 0x28);		/*5  level 5*/
			GC0312_write_cmos_sensor(0x3a, 0x28);		/*5  level 6*/
			GC0312_write_cmos_sensor(0x3b, 0x30);		/*5 level 7 */
		} else {
			GC0312_write_cmos_sensor(0xfe, 0x01);
			GC0312_write_cmos_sensor(0x0d, 0xf8);		/*new exp 3*/
			GC0312_write_cmos_sensor(0xfe, 0x00);
...
void GC0312_Sensor_Init(void)
{
	...
	GC0312_write_cmos_sensor(0xf3, 0x00);
	...
	GC0312_write_cmos_sensor(0x17, 0x14); /* 0x14 normal,  0x15 flip,  0x16,  mirror,  0x17 flip and mirror */
	GC0312_write_cmos_sensor(0x18, 0x1a);
	GC0312_write_cmos_sensor(0x19, 0x14);
	GC0312_write_cmos_sensor(0x1b, 0x48);
	GC0312_write_cmos_sensor(0x1c, 0x6c);
	...
	GC0312_write_cmos_sensor(0x22, 0xd0);
	...
	GC0312_write_cmos_sensor(0x41, 0x25);
	...
	GC0312_write_cmos_sensor(0x77, 0x54);
	GC0312_write_cmos_sensor(0x78, 0x40);
	GC0312_write_cmos_sensor(0x79, 0x62);
	/* /////////////////////////////////////////////// */
	/* /////////////////   DNDD  ///////////////////// */
	/* /////////////////////////////////////////////// */
	...
	GC0312_write_cmos_sensor(0x8c, 0x30);
	GC0312_write_cmos_sensor(0x8d, 0x60);
	/* /////////////////////////////////////////////// */
	/* ////////////////   EEINTP  //////////////////// */
	/* /////////////////////////////////////////////// */
	...
	GC0312_write_cmos_sensor(0x94, 0x04);
	GC0312_write_cmos_sensor(0x95, 0x77);   /*Sharpness*/
	...
	GC0312_write_cmos_sensor(0xa2, 0x77);
	GC0312_write_cmos_sensor(0xa4, 0x26);
	GC0312_write_cmos_sensor(0xa5, 0x38);
	GC0312_write_cmos_sensor(0xaa, 0x2a);
	GC0312_write_cmos_sensor(0xac, 0x00);
	/* /////////////////////////////////////////////// */
	/* /////////////////   GAMMA   /////////////////// */
	/* /////////////////////////////////////////////// */
	GC0312_write_cmos_sensor(0xfe, 0x00);
	GC0312_write_cmos_sensor(0xbf, 0x00);
	GC0312_write_cmos_sensor(0xc0, 0x0f);
	GC0312_write_cmos_sensor(0xc1, 0x26);
	GC0312_write_cmos_sensor(0xc2, 0x43);
	GC0312_write_cmos_sensor(0xc3, 0x5b);
	GC0312_write_cmos_sensor(0xc4, 0x6e);
	GC0312_write_cmos_sensor(0xc5, 0x7e);
	GC0312_write_cmos_sensor(0xc6, 0x97);
	GC0312_write_cmos_sensor(0xc7, 0xaa);
	GC0312_write_cmos_sensor(0xc8, 0xb9);
	GC0312_write_cmos_sensor(0xc9, 0xc6);
	...
	GC0312_write_cmos_sensor(0xfe, 0x00);
	GC0312_write_cmos_sensor(0x5f, 0x00);
	GC0312_write_cmos_sensor(0x60, 0x15);
	GC0312_write_cmos_sensor(0x61, 0x3d);
	GC0312_write_cmos_sensor(0x62, 0x58);
	GC0312_write_cmos_sensor(0x63, 0x6f);
	GC0312_write_cmos_sensor(0x64, 0x80);
	GC0312_write_cmos_sensor(0x65, 0x92);
	GC0312_write_cmos_sensor(0x66, 0xa8);
	GC0312_write_cmos_sensor(0x67, 0xb9);
	GC0312_write_cmos_sensor(0x68, 0xc7);
	GC0312_write_cmos_sensor(0x69, 0xd1);
	GC0312_write_cmos_sensor(0x6a, 0xda);
	GC0312_write_cmos_sensor(0x6b, 0xe3);
	GC0312_write_cmos_sensor(0x6c, 0xe8);
	GC0312_write_cmos_sensor(0x6d, 0xf2);
	GC0312_write_cmos_sensor(0x6e, 0xfb);
	GC0312_write_cmos_sensor(0x6f, 0xfd);
	GC0312_write_cmos_sensor(0xb1, 0x80);
	GC0312_write_cmos_sensor(0xb2, 0x90);
	GC0312_write_cmos_sensor(0xb3, 0x0b);
	GC0312_write_cmos_sensor(0xb4, 0x10);
	/* ///////////////////////////////////////////// */
	/* ///////////////////   YCP  ////////////////// */
	/* ///////////////////////////////////////////// */
	GC0312_write_cmos_sensor(0xd0, 0x40);
	GC0312_write_cmos_sensor(0xd1, 0x2c);
	GC0312_write_cmos_sensor(0xd2, 0x28);
	...
	GC0312_write_cmos_sensor(0xde, 0xa6);
	...
	GC0312_write_cmos_sensor(0x13, 0x3d);
	GC0312_write_cmos_sensor(0x18, 0x95);
	GC0312_write_cmos_sensor(0x19, 0x96);
	GC0312_write_cmos_sensor(0x1e, 0x31);
	...
	GC0312_write_cmos_sensor(0x58, 0x06);
	...
	GC0312_write_cmos_sensor(0x63, 0x14);
	...
	GC0312_write_cmos_sensor(0x6a, 0x80);
	...
	GC0312_write_cmos_sensor(0x7b, 0x5c);
	GC0312_write_cmos_sensor(0x7c, 0x08);
	GC0312_write_cmos_sensor(0xfe, 0x01);
	GC0312_write_cmos_sensor(0x90, 0x00);
	GC0312_write_cmos_sensor(0x91, 0x00);
	GC0312_write_cmos_sensor(0x92, 0xfa);
	GC0312_write_cmos_sensor(0x93, 0xe1);
	GC0312_write_cmos_sensor(0x95, 0x1d);
	GC0312_write_cmos_sensor(0x96, 0xfb);
	GC0312_write_cmos_sensor(0x97, 0x47);
	GC0312_write_cmos_sensor(0x98, 0x1d);
	GC0312_write_cmos_sensor(0x9a, 0x4a);
	GC0312_write_cmos_sensor(0x9b, 0x39);
	GC0312_write_cmos_sensor(0x9c, 0x7f);
	GC0312_write_cmos_sensor(0x9d, 0x51);
	GC0312_write_cmos_sensor(0x9f, 0x00);
	GC0312_write_cmos_sensor(0xa0, 0x00);
	GC0312_write_cmos_sensor(0xa1, 0x00);
	GC0312_write_cmos_sensor(0xa2, 0x00);
	GC0312_write_cmos_sensor(0x86, 0x6a);
	GC0312_write_cmos_sensor(0x87, 0x58);
	GC0312_write_cmos_sensor(0x88, 0x41);
	GC0312_write_cmos_sensor(0x89, 0x16);
	GC0312_write_cmos_sensor(0xa4, 0x00);
	GC0312_write_cmos_sensor(0xa5, 0x00);
	GC0312_write_cmos_sensor(0xa6, 0xd7);
	GC0312_write_cmos_sensor(0xa7, 0xab);
	GC0312_write_cmos_sensor(0xa9, 0xd9);
	GC0312_write_cmos_sensor(0xaa, 0xa5);
	GC0312_write_cmos_sensor(0xab, 0xc1);
	GC0312_write_cmos_sensor(0xac, 0xa7);
	GC0312_write_cmos_sensor(0xae, 0xa2);
	GC0312_write_cmos_sensor(0xaf, 0x94);
	GC0312_write_cmos_sensor(0xb0, 0xe3);
	GC0312_write_cmos_sensor(0xb1, 0x9e);
	GC0312_write_cmos_sensor(0xb3, 0x00);
	GC0312_write_cmos_sensor(0xb4, 0x00);
	GC0312_write_cmos_sensor(0xb5, 0x00);
	GC0312_write_cmos_sensor(0xb6, 0x00);
	GC0312_write_cmos_sensor(0x8b, 0xcb);
	GC0312_write_cmos_sensor(0x8c, 0xbb);
	GC0312_write_cmos_sensor(0x8d, 0xcb);
	GC0312_write_cmos_sensor(0x8e, 0x94);
	GC0312_write_cmos_sensor(0x94, 0x50);
	GC0312_write_cmos_sensor(0x99, 0xa6);
	GC0312_write_cmos_sensor(0x9e, 0xaa);
	GC0312_write_cmos_sensor(0xa3, 0x00);
	GC0312_write_cmos_sensor(0x8a, 0xaa);
	GC0312_write_cmos_sensor(0xa8, 0x50);
	GC0312_write_cmos_sensor(0xad, 0x55);
	GC0312_write_cmos_sensor(0xb2, 0x55);
	GC0312_write_cmos_sensor(0xb7, 0x00);
	GC0312_write_cmos_sensor(0x8f, 0x55);
	GC0312_write_cmos_sensor(0xb8, 0xd6);
	GC0312_write_cmos_sensor(0xb9, 0x8c);
	/* /////////////////////////////////////////////// */
	/* //////////////////   CC    //////////////////// */
	/* /////////////////////////////////////////////// */
	GC0312_write_cmos_sensor(0xfe, 0x01);
	GC0312_write_cmos_sensor(0xd0, 0x44);  /*42*/
	GC0312_write_cmos_sensor(0xd1, 0xfa);
	GC0312_write_cmos_sensor(0xd2, 0x06);
	GC0312_write_cmos_sensor(0xd3, 0xf8);
	GC0312_write_cmos_sensor(0xd4, 0x47);
	GC0312_write_cmos_sensor(0xd5, 0xf1);
	GC0312_write_cmos_sensor(0xd6, 0x44);  /*4c 0706*/
	GC0312_write_cmos_sensor(0xd7, 0xf9);  /*f5 0706*/
	GC0312_write_cmos_sensor(0xd8, 0x07);
	GC0312_write_cmos_sensor(0xd9, 0xf0);
	GC0312_write_cmos_sensor(0xda, 0x40);
	GC0312_write_cmos_sensor(0xdb, 0xde);  /*d8 sat 106->112*/
	/* ///////////////////////////////////////////////// */
	/* ////////////////////   LSC   //////////////////// */
	/* ///////////////////////////////////////////////// */
	GC0312_write_cmos_sensor(0xfe, 0x01);
	...
	GC0312_write_cmos_sensor(0xc3, 0x01);
	GC0312_write_cmos_sensor(0xc4, 0x32);
	GC0312_write_cmos_sensor(0xc5, 0x0a);
	GC0312_write_cmos_sensor(0xc6, 0x05);
	GC0312_write_cmos_sensor(0xc7, 0x0a);
	GC0312_write_cmos_sensor(0xc8, 0x05);
	GC0312_write_cmos_sensor(0xc9, 0x08);
	GC0312_write_cmos_sensor(0xdc, 0x00);
	...
	GC0312_write_cmos_sensor(0x47, 0xff);
	...
	GC0312_write_cmos_sensor(0x2a, 0x04);		/*4step level 2  25*/
	GC0312_write_cmos_sensor(0x2b, 0x04);
	GC0312_write_cmos_sensor(0x2c, 0x08);		/*8step level 3  12.5*/
	GC0312_write_cmos_sensor(0x2d, 0x05);
	GC0312_write_cmos_sensor(0x2e, 0x0a);		/*10step level 4  10*/
	GC0312_write_cmos_sensor(0x2f, 0x06);
	GC0312_write_cmos_sensor(0x30, 0x0c);		/*12step  level 5  10*/
	GC0312_write_cmos_sensor(0x31, 0x06);
	GC0312_write_cmos_sensor(0x32, 0x0c);		/*16 step  level 6  10*/
	GC0312_write_cmos_sensor(0x33, 0x06);
	GC0312_write_cmos_sensor(0x34, 0x0c);		/*20step level 7  10*/
	GC0312_write_cmos_sensor(0x35, 0x10);		/*2x level 1*/
	GC0312_write_cmos_sensor(0x36, 0x10);		/*2x level 2*/
	GC0312_write_cmos_sensor(0x37, 0x18);		/*3x level 3*/
	GC0312_write_cmos_sensor(0x38, 0x18);		/*3x level 4*/
	GC0312_write_cmos_sensor(0x39, 0x28);		/*5x level 5*/
	GC0312_write_cmos_sensor(0x3a, 0x28);		/*5x level 6*/
	GC0312_write_cmos_sensor(0x3b, 0x30);		/*6x level 7*/
	/* ///////////////////////////////////////////////// */
	/* /////////////////////  DVP   //////////////////// */
	/* ///////////////////////////////////////////////// */
...
BOOL GC0312_set_Edge(UINT16 para)
{
	...
	case ISP_EDGE_MIDDLE:
		GC0312_write_cmos_sensor(0xfe, 0x00);
		GC0312_write_cmos_sensor(0x95, 0x77);
		GC0312_write_cmos_sensor(0xfe, 0x00);
		break;
...
BOOL GC0312_set_Brightness(UINT16 para)
{
	...
	case ISP_BRIGHT_MIDDLE:
		...
		GC0312_write_cmos_sensor(0xd5, 0x00);
		GC0312_write_cmos_sensor(0xfe, 0x01);
		GC0312_write_cmos_sensor(0x13, 0x3d);	/*39  20160406 */
		GC0312_write_cmos_sensor(0xfe, 0x00);
		break;
...
{
	SENSORDB("GC0312_set_param_banding: para = %d \n", para);
	switch (para) {
	case AE_FLICKER_MODE_50HZ:
		...
		GC0312_write_cmos_sensor(0xfe, 0x01);
		GC0312_write_cmos_sensor(0x25, 0x00);
		GC0312_write_cmos_sensor(0x26, 0x9a);		/*9a   1step   30*/
		GC0312_write_cmos_sensor(0x27, 0x01);
		GC0312_write_cmos_sensor(0x28, 0x34);		/*2step  level 1  30*/
		GC0312_write_cmos_sensor(0x29, 0x02);
		GC0312_write_cmos_sensor(0x2a, 0x68);		/*4step level 2  25*/
		GC0312_write_cmos_sensor(0x2b, 0x04);
		GC0312_write_cmos_sensor(0x2c, 0x36);		/*8step level 3  14*/
		GC0312_write_cmos_sensor(0x2d, 0x04);
		GC0312_write_cmos_sensor(0x2e, 0xd0);		/*10step level 4  12.5*/
		GC0312_write_cmos_sensor(0x2f, 0x06);
		GC0312_write_cmos_sensor(0x30, 0x04);		/*15step  level 5  10*/
		GC0312_write_cmos_sensor(0x31, 0x06);
		GC0312_write_cmos_sensor(0x32, 0x04);		/*16 step  level 6  10*/
		GC0312_write_cmos_sensor(0x33, 0x06);
		GC0312_write_cmos_sensor(0x34, 0x04);		/*17step level 7  10*/
		GC0312_write_cmos_sensor(0x35, 0x10);		/*2x level 1*/
		GC0312_write_cmos_sensor(0x36, 0x10);		/*2x   level 2*/
		GC0312_write_cmos_sensor(0x37, 0x18);		/*3x   level 3*/
		GC0312_write_cmos_sensor(0x38, 0x18);		/*3x  level 4*/
...
UINT32 GC0312YUVSensorMinMaxFps(UINT32 u4FrameRateMin, UINT32 u4FrameRateMax)
{
	...
	GC0312_MPEG4_encode_mode = KAL_TRUE;
	SENSORDB("GC0312YUVSensorMinMaxFps: min = %d, max = %d\n",
	...
	if ((u4FrameRateMin == 6) && (u4FrameRateMax == 24)) {
		...
		GC0312_write_cmos_sensor(0x2e, 0x0a);		/*10step level 4  10*/
		GC0312_write_cmos_sensor(0x2f, 0x06);
		GC0312_write_cmos_sensor(0x30, 0x0c);		/*15step  level 5  6.67*/
		GC0312_write_cmos_sensor(0x31, 0x08);
		GC0312_write_cmos_sensor(0x32, 0x10);		/*16step  level 6  6.25*/
		GC0312_write_cmos_sensor(0x33, 0x0a);
		GC0312_write_cmos_sensor(0x34, 0x14);		/*27step level 7  5.88*/
		GC0312_write_cmos_sensor(0x35, 0x10);		/*2x level 1*/
		GC0312_write_cmos_sensor(0x36, 0x10);		/*2x level 2*/
		GC0312_write_cmos_sensor(0x37, 0x18);		/*3x level 3*/
		GC0312_write_cmos_sensor(0x38, 0x18);		/*3x level 4*/
		...
		GC0312_write_cmos_sensor(0x30, 0x0c);		/*15step  level 5  6.67*/
		GC0312_write_cmos_sensor(0x31, 0x08);
		GC0312_write_cmos_sensor(0x32, 0x10);		/*16 step  level 6  6.25*/
		GC0312_write_cmos_sensor(0x33, 0x0a);
		GC0312_write_cmos_sensor(0x34, 0x14);		/*17step level 7  5.88*/
		GC0312_write_cmos_sensor(0x35, 0x10);		/*2x level 1*/
		GC0312_write_cmos_sensor(0x36, 0x10);		/*2x level 2*/
		GC0312_write_cmos_sensor(0x37, 0x18);		/*3x level 3*/
		GC0312_write_cmos_sensor(0x38, 0x18);		/*3x level 4*/
